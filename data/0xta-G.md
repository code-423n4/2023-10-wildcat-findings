...
| :----: | :----------------------------------------------------------------------------------------------------------------- | :-----: |
| [G-01] | Avoid contract existence checks by using low level calls                                                           |   29    |
| [G-02] | `<X> += <Y>` Costs more gas than `<X> = <X> + <Y>` for state variables                                             |    4    |
| [G-03] | Using fixed bytes is cheaper than using string                                                                     |    3    |
| [G-04] | MULTIPLE ADDRESS/ID MAPPINGS CAN BE COMBINED INTO A SINGLE MAPPING OF AN ADDRESS/ID TO A STRUCT, WHERE APPROPRIATE |    3    |
| [G-05] | SHOULD USE ARGUMENTS INSTEAD OF STATE VARIABLE                                                                     |    1    |
| [G-06] | USE BITMAPS TO SAVE GAS                                                                                            |    1    |
| [G-07] | INTERNAL FUNCTIONS NOT CALLED BY THE CONTRACT SHOULD BE REMOVED TO SAVE DEPLOYMENT GAS                             |    5    |
| [G-08] | Structs can be packed into fewer storage slots by editing time variables                                           |    4    |
| [G-09] | Use constants instead of type(uintx).max                                                                           |    1    |
| [G-10] | Use nested if and, avoid multiple check combinations &&                                                            |    1    |
| [G-11] | Caching global variables is more expensive than using the actual variable (use msg.sender instead of caching it)   |    2    |
| [G-12] | A modifier used only once and not being inherited should be inlined to save gas                                    |    4    |
| [G-13] | abi.encode() is less efficient than abi.encodePacked()                                                             |    1    |
| [G-14] | Using > 0 costs more gas than != 0 when used on a uint in a require() and assert statement                         |   12    |
| [G-15] | Do not calculate constants                                                                                         |    2    |
| [G-16] | Use do while  loops instead of for loops                                                                           |   12    |
| [G-17] | Refactor event to avoid emitting data that is already present in transaction data                                  |    1    |
| [G-18] | Missing zero address checks in the constructor                                                                     |    4    |
| [G-19] | Sort Solidity operations using short-circuit mode                                                                  |   11    |
| [G-20] | Pre-increment and pre-decrement are cheaper than +1 ,-1                                                            |    2    |
| [G-21] | Using delete statement can save gas                                                                                |    5    |
...
## [G-05] SHOULD USE ARGUMENTS INSTEAD OF STATE VARIABLE
...
## [G-08] Structs can be packed into fewer storage slots by editing time variables
...
## [G-14] Using > 0 costs more gas than != 0 when used on a uint in a require() and assert statement
...
## [G-17] Refactor event to avoid emitting data that is already present in transaction data
...
## [G-18] Missing zero address checks in the constructor
...
https://github.com/code-423n4/2023-10-wildcat/blob/main/src/WildcatMarketControllerFactory.sol#L79
